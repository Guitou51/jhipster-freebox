...
import com.jhipster.freebox.config.ApplicationProperties
import com.jhipster.freebox.config.MapDbProperties
...
@EnableConfigurationProperties(LiquibaseProperties::class, ApplicationProperties::class, MapDbProperties::class)
class JhipsterFreeboxApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes JhipsterFreebox.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<JhipsterFreeboxApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(JhipsterFreeboxApp::class.java)

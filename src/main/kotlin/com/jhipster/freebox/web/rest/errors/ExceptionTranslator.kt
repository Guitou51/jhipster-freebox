package com.jhipster.freebox.web.rest.errors
...
class ExceptionTranslator : ProblemHandling, SecurityAdviceTrait {
    ...
    @ExceptionHandler
    fun handleEmailAlreadyUsedException(ex: com.jhipster.freebox.service.EmailAlreadyUsedException, request: ServerWebExchange): Mono<ResponseEntity<Problem>> {
    ...
    @ExceptionHandler
    fun handleUsernameAlreadyUsedException(ex: com.jhipster.freebox.service.UsernameAlreadyUsedException, request: ServerWebExchange): Mono<ResponseEntity<Problem>> {
        val problem = LoginAlreadyUsedException()
        return create(problem, request, HeaderUtil.createFailureAlert(applicationName, true, problem.entityName, problem.errorKey, problem.message))
    }

    @ExceptionHandler
    fun handleInvalidPasswordException(ex: com.jhipster.freebox.service.InvalidPasswordException, request: ServerWebExchange): Mono<ResponseEntity<Problem>> {
